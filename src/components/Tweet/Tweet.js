...
export default function Tweet() {
    ...
    <div className='tweet_div'>
        ...
        <div className='twitter_account'>
            ...
            <button> <a href='https://twitter.com/BodhwaniKanish' target="_blank" rel='noreferrer'> <FaTwitter size={"1em"} className="tweet-icon" color="#fff"/> <p className='follow_text'> Follow </p> </a></button>
        </div>
        <div className='tweet'>
            {/* {tweetsArray.map((el) => {
